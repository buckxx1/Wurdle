document.addEventListener("DOMContentLoaded", () => {
    ...
    const words = ["swore", "barks", "couch", "train", "fleck", "gross", "fruit", "joint", "legal", "cloud", "tower", "undue", "whose", "mayor", "drawn", "angle", "knees", "movie", "alive", "crime", "doubt", "crown", "chilly", "enemy", "gates", "copes", "scope", "rinks", "dozen", "river", "drown", "sharp", "seven", "boxes", "heads", "blood", "films", "scare"];
